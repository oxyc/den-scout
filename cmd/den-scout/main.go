...
func main() {
	...
	srv := &http.Server{
		...
		// handler is a PARSE-time cap — by the time decodeConfig refuses a 16 KiB-plus config segment,
		...
		// ReadHeaderTimeout. 32 KiB is twice the config-segment ceiling, which is the largest thing that
